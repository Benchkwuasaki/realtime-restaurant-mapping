...
class LeaveTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'is_per_event'            => 'required|boolean',     
            'max_lifetime_grants'     => 'nullable|integer|min:0|max:255', 
            'availment_type'          => 'required|in:continuous,intermittent,both', 
            'availment_deadline_days' => 'nullable|integer|min:0|max:255',
