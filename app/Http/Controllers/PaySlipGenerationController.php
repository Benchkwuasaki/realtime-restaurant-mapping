...
class PaySlipGenerationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // ── Periods — ONLY Processed or Closed (i.e. payroll has been run) ──
        ...
        $bulkClassification = $request->string('classification')->toString(); // '' = all
    ...
    /**
     * "Mar 1 – 15, 2026"  (same month)
     * "Jan 26 – Feb 10, 2026"  (cross month)
     */
