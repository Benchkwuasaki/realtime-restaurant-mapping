...
class LeaveTypeSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $leaveTypes = [
            ...
            // availment_type: intermittent — employees file individual days as needed.
            [
            ...
            // availment_type: intermittent — the 5 days need not be taken consecutively.
            [
            ...
            // NOT pre-seeded as a balance row; granted dynamically by
            // LeaveBalanceService::applyThresholdGrants() when VL ≥ 10.
            // availment_type: intermittent — the 3 days are used on separate occasions.
            [
            ...
            // ── Maternity Leave ────────────────────────────────────────────────
            // Three entitlement rows keyed by event_type:
            //   live_birth             → 105 days  (RA 11210)
            //   live_birth_solo_parent → 120 days  (RA 11210 + RA 8972 solo parent bonus)
            //   miscarriage            →  60 days  (RA 11210, covers emergency termination
            //                                        of pregnancy regardless of frequency)
            // No years-of-service requirement for any variant.
            // Eligible: Female employees only.
            // availment_type: continuous — taken as one unbroken block per event.
            [
                ...
                'is_convertible'         => false,
                'is_accrual'             => false,
                'availment_type'         => 'continuous',
                'status'                 => true,
                'requirements'           => [
                    'Leave Application Form',
                    'Medical Certificate',
                    'Birth Certificate or Fetal Death Certificate (as applicable)',
                ],
                'entitlements' => [
                    [
                        'event_type' => 'live_birth',
                        'years_of_service' => 0,
                        'days_entitled' => 105.0,
                        'leave_entitlement_description' => '105 working days for live birth. No minimum service requirement.',
                    ],
                    [
                        'event_type' => 'live_birth_solo_parent',
                        'years_of_service' => 0,
                        'days_entitled' => 120.0,
                        'leave_entitlement_description' => '105 days + 15-day solo parent extension (RA 8972) = 120 working days for live birth where the employee holds a valid Solo Parent ID.',
                    ],
                    [
                        'event_type' => 'miscarriage',
                        'years_of_service' => 0,
                        'days_entitled' => 60.0,
                        'leave_entitlement_description' => '60 working days for miscarriage or emergency termination of pregnancy. Applies regardless of frequency. No minimum service requirement.',
                    ],
                ],
            ],
            ...
            // availment_type: continuous — taken around the delivery event as one block.
            [
            ...
            // availment_type: intermittent — 7 days used on separate occasions as parental
            // duties arise throughout the year.
            [
            ...
            // availment_type: continuous — post-surgery recovery is one unbroken block.
            [
            ...
            // availment_type: intermittent — used on separate days to attend medical,
            // legal, and other appointments as needed.
            [
            ...
            // ── Study Leave ────────────────────────────────────────────────────
            // availment_type: both — bar/board exam days are intermittent (scattered exam
            // days); the 6-month master's degree block is continuous.
            [
            ...
            // availment_type: continuous — recovery from a duty-related injury is one
            // unbroken recuperation period.
            [
            ...
            // availment_type: intermittent — employees may use days across non-consecutive
            // days during the calamity period (e.g. evacuation day, cleanup day).
            [
            ...
            // ── Leave Without Pay ──────────────────────────────────────────────
            // availment_type: both — can be a single block or scattered days depending
            // on the employee's situation and agency head approval.
            [
        ...
        foreach ($leaveTypes as $data) {
            ...
            foreach ($entitlements as $ent) {
                LeaveEntitlement::create([
                    ...
                    'event_type' => $ent['event_type'] ?? null,
