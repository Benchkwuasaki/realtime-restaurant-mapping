...
function EmploymentStep({ data, setData, err, items, salaryGradeSteps, employmentClassifications }: {
    ...
    // After creating a classification, store its name here so we can
    // auto-select it once Inertia re-delivers the updated props
    ...
    return (
        <>
            <div className="grid grid-cols-3 gap-5">
                ...
                {/* ── Employment Classification + Manage button ── */}
                <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                        <Select
                            ...
                            onValueChange={v => setData("employment_classification", v)}
                        >
                ...
                <div className="space-y-2">
                    ...
                    <Select
                        ...
                        onValueChange={v => { setData("salary_grade", v); setData("salary_grade_step_id", "") }}
                    >
                ...
                <div className="space-y-2">
                    ...
                    <Select
                        ...
                        onValueChange={v => setData("salary_grade_step_id", v)}
...
export default function CreateEmployeeForm({ items, salaryGradeSteps, employmentClassifications }: CreateEmployeeProps) {
        ...
        <div className="px-10 pt-5">
            ...
            <form onSubmit={submit}>
                <div className="mt-8 p-6 border rounded-md">
                    ...
                    {currentStep === 0 && (
                        <PersonalStep data={data} setData={setData} err={err} />
                    )}
                    {currentStep === 1 && (
                        <EmploymentStep
                            data={data}
